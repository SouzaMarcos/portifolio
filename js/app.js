...
/*	$(".section.white").css('min-height',$(window).height()+1);
	...
	$('.section .conteudo section.trabalhos').hide();
	$('.section .conteudo section.contato').hide();
	...
	$('#menu ul li').click(function () {
    	if($(this).index()>0){
	    	...
	    	$('.slider').slider('to',$(this).index());
	    	$('.slider').slider('pause');*/
	    	$('.section .conteudo section').each(function(){
	    		$(this).hide();
	    	});
	    	$('.section .conteudo section.'+$(this).find('a').attr('href')).fadeIn(2000);
    ...
    function drawLines(p) {
        ...
        for(var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(156,217,249,'+ (p.active+0.1)+')';
            ctx.stroke();
        }
    }
    ...
    function Circle(pos,rad,color) {
        ...
        this.draw = function() {
            ...
            ctx.fillStyle = 'rgba(156,217,249,'+ (_this.active+0.1)+')';
            ctx.fill();
        };
    }
